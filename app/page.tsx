...
const faqs = [
  ...
  {
    question: "How can a deck be good for me?",
    answer:
      "Relax, its a great fit for everyone",
  },
  // More questions...
]
        ...
        <div className="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[white] to-[white] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-200">
          ...
          <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
            <div className="absolute left-[calc(50%-19rem)] top-[calc(50%-36rem)] transform-gpu blur-3xl">
              <div
                ...
                className="aspect-[1097/1023] w-[68.5625rem] bg-gradient-to-r from-[#ff4694] to-[white] opacity-25"
              />
            </div>
          </div>
        ...
        <div className="relative isolate mt-32 bg-white px-6 sm:mt-56 lg:px-8">
          ...
          >
            <div
              ...
              className="mx-auto aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[white] to-[white] opacity-30"
            />
          </div>
          <div className="mx-auto max-w-2xl sm:text-center">
